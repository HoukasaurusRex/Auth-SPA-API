# Contributing to oauth-api

First and foremost, thank you! We appreciate that you want to contribute to oauth-api, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for oauth-api**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for oauth-api:

- star the [project](https://github.com/Pterobyte/oauth-api)
- tweet your support for oauth-api
...
- **version**: (required) please note the version of oauth-api are you using
...
The original poster or the maintainers of oauth-api may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/oauth-api
